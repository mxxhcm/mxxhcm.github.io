...
接下来的公式主要对$\frac{\parital \mathbf{y}}{\partial x}, \frac{\parital y}{\partial \mathbf{x}}, \frac{\parital \mathbf{y}}{\partial \mathbf{x}}, \frac{\parital \mathbf{Y}}{\partial x},\frac{\parital y}{\partial \mathbf{X}}$这种组合分别考虑。
